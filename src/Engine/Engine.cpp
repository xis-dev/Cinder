...
{
	textures.addResource("default", Texture("assets/Textures/empty.jpg"));
	textures.addResource("aphex", Texture("assets/Textures/aphex.gif"));
	textures.addResource("floor", Texture("assets/Textures/woodenFloor.jpg"));
	textures.addResource("container", Texture("assets/Textures/container_diffuse.png"));
	textures.addResource("container_specular", Texture("assets/Textures/container_specular.png", Texture::Specular));
}


void Engine::createShaders()
{
	shaders.addResource("lit", Shader("assets/Shaders/default.vert", "assets/Shaders/default_lit.frag"));
	shaders.addResource("unlit", Shader("assets/Shaders/default.vert", "assets/Shaders/default_unlit.frag"));
	shaders.addResource("textured_lit", Shader("assets/Shaders/default.vert", "assets/Shaders/textured_lit.frag"));
	shaders.addResource("grid", Shader("assets/Shaders/world_grid.vert", "assets/Shaders/world_grid.frag"));
	shaders.addResource("icon", Shader("assets/Shaders/item_icon.vert", "assets/Shaders/item_icon.frag"));
}

void Engine::createMeshes()
{
	meshes.addResource("cube", Mesh(Cube::vertices, Cube::indices, materials.tryGetResource("container")));
	meshes.addResource("plane", Mesh(Plane::vertices, Plane::indices, materials.tryGetResource("default")));
...
{
	Texture* directionalLightIcon = textures.addResource("icon_directionalLight", Texture("assets/Textures/light-icon.png"));
	Texture* pointLightIcon = textures.addResource("icon_pointLight", Texture("assets/Textures/light-icon.png"));
	Texture* spotLightIcon = textures.addResource("icon_spotLight", Texture("assets/Textures/light-icon.png"));
